    ...
    <Card>
      <CardContent className="p-6 flex flex-col items-center">
        <div className="w-[124px] h-[124px] relative rounded-full">
          <Image src={user?.image||avatar} alt="avatar" className="w-full h-full object-cover rounded-full" />
          <Button asChild
            size="icon"
        ...
        <div className="mt-1.5 text-sm font-medium text-default-500">{user?.designation}</div>
      </CardContent>
    </Card>
  );
};
